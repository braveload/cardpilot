...
- 공식 규칙 확인 상품 27종: BC 바로카드 6종, KB국민카드 10종, 현대카드 10종, 신한카드 Mr.Life 1종 (카드별 출처·기준일·실적 기준은 `card-rules.js` 참조)
...
- 추가 상품 목록 154종: 은행·카드사 BC 회원사 12곳의 공식 상품 목록(최대 10종씩, 회원사별 현재 조회 가능한 수량 적용), 삼성·우리·롯데 각 10종, 하나·신한·NH농협 일반 카드 각 10종. 개별 실적·제외 기준 확인 전까지 거래 판정/합산을 보류함
- 전체 상품 목록 180종 중 공식 판정 규칙 27종, 규칙 검증 중 153종. 신한카드 Mr.Life는 공식 상품 안내에서 전월 30만원 최소 구간과 명시된 제외 거래를 확인해 등록함. 상품 목록 등록을 판정 규칙 확인 완료로 오인하지 않도록 상태를 분리함
